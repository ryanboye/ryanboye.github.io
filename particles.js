...
document.getElementById('focus').appendChild(container);
...
// parameters = [[[1, 1, 0.4], 5], [[0.95, 1, 0.4], 4], [[0.90, 1, 0.4], 3], [[0.85, 1, 0.4], 2], [[0.80, 1, 0.4], 1]];
parameters = [[[1, 1, 0.4], 5], [[0.95, 1, 0.4], 4]];
